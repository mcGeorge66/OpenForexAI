...
class CloseReason(StrEnum):
    ...
    REJECTED = "REJECTED"               # order rejected by broker before fill
...
class OrderBookEntry(BaseModel):
    ...
    # ── Timing ────────────────────────────────────────────────────────────────
    requested_at: datetime                      # local UTC request timestamp
    opened_at: datetime | None = None          # broker-confirmed open timestamp
    close_requested_at: datetime | None = None # local UTC close request timestamp
    closed_at: datetime | None = None          # broker-confirmed close timestamp
    ...
    # ── Sync ──────────────────────────────────────────────────────────────────
    sync_confirmed: bool = False                # legacy sync flag
    confirmed_by_broker: bool = False          # authoritative broker-side confirmation of the full record
