...
class MonitoringEventType(StrEnum):
    ...
    M5_CANDLE_SAVED = "m5_candle_saved"            # M5 candle persisted to database
    ...
    AGENT_TRIGGER_RECEIVED = "agent_trigger_received"
    AGENT_TRIGGER_SKIPPED = "agent_trigger_skipped"
    AGENT_BACKLOG_DETECTED = "agent_backlog_detected"
    AGENT_DECISION_SNAPSHOT_BUILT = "agent_decision_snapshot_built"
    AGENT_DECISION_SNAPSHOT_INVALID = "agent_decision_snapshot_invalid"
    ...
    LLM_TURN_COMPLETED = "llm_turn_completed"
    LLM_TURN_FAILED = "llm_turn_failed"
    LLM_HTTP_ATTEMPT_STARTED = "llm_http_attempt_started"
    LLM_HTTP_ATTEMPT_COMPLETED = "llm_http_attempt_completed"
    LLM_HTTP_ATTEMPT_FAILED = "llm_http_attempt_failed"
    ...
    # ── EventComposer runs ────────────────────────────────────────────────────
    EC_RUN_STARTED   = "ec_run_started"
    EC_RUN_COMPLETED = "ec_run_completed"
    EC_RUN_FAILED    = "ec_run_failed"
    EC_RUN_OUTPUT    = "ec_run_output"
...
class MonitoringEvent(BaseModel):
    ...
    event_type: str                        # MonitoringEventType value or any bus EventType string
