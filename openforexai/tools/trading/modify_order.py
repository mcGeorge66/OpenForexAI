...
class ModifyOrderTool(BaseTool):
    ...
    async def execute(self, arguments: dict[str, Any], context: ToolContext) -> Any:
        ...
        # Resolve the local order book entry BEFORE sending the request: entry_id is a
        # schema-required field of ORDER_MODIFY_REQUEST (bus validation rejects the
        # message otherwise) and we need it to persist the change afterwards.
        ...
        if matching_entry is not None and result_status != "REJECTED":
