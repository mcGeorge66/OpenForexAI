...
class AutoPlaceOrderTool(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "atr_period": {
                "type": "integer",
                "description": "ATR lookback period for automatic SL/TP sizing. Default: 14.",
                "minimum": 1,
                "maximum": 500,
            },
            "atr_timeframe": {
                "type": "string",
                "description": "Timeframe for ATR calculation. Default: M5.",
                "enum": ["M5", "M15", "M30", "H1", "H4", "D1"],
            },
            "sl_atr_factor": {
                "type": "number",
                "description": "SL distance as ATR multiple. Default: 1.5.",
                "minimum": 0.1,
                "maximum": 10.0,
            },
            "tp_atr_factor": {
                "type": "number",
                "description": "TP distance as ATR multiple. Default: 3.0.",
                "minimum": 0.1,
                "maximum": 20.0,
            },
            "reasoning": {
